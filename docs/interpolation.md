...
## InterClassInterpolation

ICI interpolator balances the samples for all the presented classes in each site. At the end of the interpolation, all sites will have the
